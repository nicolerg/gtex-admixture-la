...
af = sys.argv[4] # snp_to_effect_af.tsv.gz
outdir = sys.argv[5]

allpairs = indir + '/'+tissue+'/'+tissue+'-LocalAA-GlobalAA-merged-allpairs.tsv.gz'
local_out = outdir + '/'+tissue+'.filtered.local.allpairs.tsv.gz'
global_out = outdir + '/'+tissue+'.filtered.global.allpairs.tsv.gz'
