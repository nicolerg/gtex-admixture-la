...
def normalize_expression(expression_df, expression_threshold, min_samples):
    """
...
if __name__=='__main__':
    ...
    parser.add_argument('--expression_threshold', type=np.double, help='Selects genes with > expression_threshold expression in at least min_samples')
    parser.add_argument('--min_samples', type=np.int32, help='Minimum number of samples that must satisfy thresholds')
    ...
    quant_std_df, quant_df = normalize_expression(expression_df, 
