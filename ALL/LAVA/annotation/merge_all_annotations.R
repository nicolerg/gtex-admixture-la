...
if(!file.exists("/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-collapsed-wide.RData")){

	if(!file.exists('/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-tmp.RData')){
		...
		print(head(f))
		f <- unique(f)
		save(f, file="/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-tmp.RData")

	} else {
		load("/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-tmp.RData")
	}

	if(!file.exists("/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-collapsed.RData")){
		...
		save(f_collapsed, file="/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-collapsed.RData")
	} else {
		load("/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-collapsed.RData")
	}
	...
	head(f)
	save(f, file="/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-collapsed-wide.RData")
} else {
	load("/mnt/lab_data/montgomery/nicolerg/local-eqtl/admixed/merged/f_all-merged-collapsed-wide.RData")
}
